...
import { Calendar, MessageSquare, Users, DollarSign, TrendingUp, BarChart2, Clock, Camera, Upload, Eye } from 'lucide-react';
...
const PhotographerDashboard = () => {
  ...
  const stats = [
    { name: 'Active Leads', value: '12', change: '+33%', icon: Users, color: 'bg-blue-100 text-blue-600' },
    { name: 'This Month Revenue', value: '₹45,000', change: '+25%', icon: DollarSign, color: 'bg-green-100 text-green-600' },
    { name: 'Bookings', value: '8', change: '+20%', icon: Calendar, color: 'bg-purple-100 text-purple-600' },
    { name: 'Messages', value: '18', change: '+12%', icon: MessageSquare, color: 'bg-orange-100 text-orange-600' },
  ];

  const quickActions = [
    {
      title: 'Upload Portfolio',
      description: 'Add new photos to showcase your work',
      icon: Upload,
      href: '/portfolio',
      color: 'bg-blue-500'
    },
    {
      title: 'View Leads',
      description: 'Check new client inquiries and leads',
      icon: Users,
      href: '/crm',
      color: 'bg-green-500'
    },
  ...
  const upcomingBookings = [
    { id: '1', client: 'Anjali Mehta', date: '2025-01-15', time: '10:00 AM', type: 'Wedding Shoot', location: 'Juhu Beach, Mumbai' },
    { id: '2', client: 'Vikram Singh', date: '2025-01-18', time: '2:00 PM', type: 'Product Photography', location: 'Studio 7, Delhi' },
    { id: '3', client: 'Neha Sharma', date: '2025-01-22', time: '11:30 AM', type: 'Family Portrait', location: 'City Park, Bangalore' },
  ];

  const recentLeads = [
    { id: '1', name: 'Arjun Kumar', inquiry: 'Wedding photography package inquiry', date: '2025-01-05', status: 'New' },
    { id: '2', name: 'Riya Patel', inquiry: 'Corporate event coverage', date: '2025-01-04', status: 'Contacted' },
    { id: '3', name: 'Sanjay Verma', inquiry: 'E-commerce product shoot', date: '2025-01-03', status: 'New' },
  ];
      ...
      <div className="space-y-8">
                ...
                {upcomingBookings.map((booking) => (
                  <tr key={booking.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <Link to={`/bookings/${booking.id}`} className="text-blue-600 hover:text-blue-900 font-medium">
                        Details
                      </Link>
                    </td>
                  </tr>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/crm" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
              View all →
            </Link>
          </div>
